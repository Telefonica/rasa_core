...
import rasa_core.utils_extra
import rasa_core.utils_extra.io
...
def read_global_config() -> Dict[Text, Any]:
    ...
    try:
        return rasa_core.utils_extra.io.read_config_file(GLOBAL_USER_CONFIG_PATH)
    except Exception:
...
def write_global_config_value(name: Text, value: Any) -> None:
    ...
    try:
        ...
        c[name] = value
        rasa_core.utils.dump_obj_as_yaml_to_file(GLOBAL_USER_CONFIG_PATH, c)
